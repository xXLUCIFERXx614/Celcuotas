          ...
          >
            ...
            <div className="carousel-inner">
              <div className="carousel-item active">
                <img
                  src="src/assets/img/carrusel2.png"
          ...
          {iphoneProducts.map((product) => (
            ...
            >
              ...
              <div className="info-product">
                ...
                <button className="/Credito">Crédito</button>
              </div>
            </div>
          ))}
        </div>
                ...
                <div className="modal-dialog" style={{ border: '2px solid #FF7900' }}>
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            ...
                            <button type="button" className="btn btn-primary" onClick={() => onAddProduct(product)}>Añadir al carrito</button>
                        </div>
                    </div>
                </div>
            </div>
