            ...
            <div className="row row-cols-7">
              ...
              <div className="col">
                <Link to="/Tecno">
                  <div className="rounded-circle-container">
                    <img
                      src="/img/Marcas/TecnoMobile.png"
                      alt="Tecno"
                      className="img-fluid"
                    />
                  </div>
