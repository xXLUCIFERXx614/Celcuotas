...
const Samsung = ({
    ...
    const samsungProducts = data.filter(product => product.id.startsWith('Samsung'));
                    ...
                    <div id="carouselExampleCaptions" className="carousel slide custom-carousel">
                        ...
                        <div className="carousel-inner">
                            ...
                            <div className="carousel-item">
                                <img src="src/assets/img/carrusel2.png" className="d-block w-100" alt="1" />
                                <div className="carousel-caption d-none d-md-block"></div>
                            </div>
                            <div className="carousel-item">
                                <img src="src/assets/img/carrusel2.png" className="d-block w-100" alt="2" />
                                <div className="carousel-caption d-none d-md-block"></div>
                            </div>
                        </div>
                    ...
                    <div className="modal-dialog" style={{ border: '2px solid #FF7900' }}>
                        <div className="modal-content">
                            ...
                            <div className="modal-footer">
                                ...
                                <button type="button" onClick={() => onAddProduct(product)}>Añadir al carrito</button>
                            </div>
                        </div>
                    </div>
                </div>
